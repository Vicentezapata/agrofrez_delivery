    ...
    <div class="card-body">
      <div class="card-group mb-4">
            ...
            <div class="card shadow ">
                <div class="card-header">
                  ...
                  <table class="table ">
                    ...
                    <tbody id="detalleCarro" style="height: 612px;">
                    </tbody>
                  </table>
                </div> 
                </div>
       ...
       <div class="card-group ">
          <div class="col-sm-6" >
              <div class="card shadow mt-3"  id="cupones">
                <div class="card-header" style="background-color: #7ac4008c;">
                  <h4>Cupon de descuento</h4>
                </div>
                <div class="card-body">
                  <div class="form-group">
                      <label for="sel1">Ingresa tu codigo de descuento</label>
                      <div class="input-group mb-3">
                      <input type="text" id="input_desc" class="form-control" aria-describedby="basic-addon2">
                      <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="button" onclick = "validarDescuento()" >Aplicar</button>
                      </div>
                    </div>
                    </div>
                </div>
      ...
      <div class="card-footer text-muted">
          <button class="btn btn-success my-2 my-sm-0" value="convencional" id="btn_pago" type="submit">Realizar pedido</button>
      </div>
    </div>
