                ...
                <div class="card-body">
                  <div class="form-group">
                      ...
                      <select type="text" name="metodoPago" class="form-control" id="metodoPago" onchange="mostrarInfoPago(this.value)">
                        ...
                        <option value="1">Opcion proximamente disponible (Webpay)</option>
...
<!-- Footer -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-5 mb-lg-0">
            ...
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item">
               ...
               <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://api.whatsapp.com/send?phone=994372359&text=Hola%2C%20deseo%20conocer mas información sobre los productos ofrecidos." target="_blank">
          ...
          <div class="col-md-4">
            ...
            <i class="fa fa-phone text-white"></i><i class="lead m-2 text-white">+994372359</i>
          </div>
        </div>
      </div>
    </footer>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>&copy; Agrofrez 20XX</small>
      </div>
    </div>
